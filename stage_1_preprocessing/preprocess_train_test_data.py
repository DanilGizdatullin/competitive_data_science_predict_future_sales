...
def train_test_preprocess():
    ...
    train.to_csv(os.path.join(PATH_TO_DATA, 'sales_train_preprocessed.csv'), index=False)
    test.to_csv(os.path.join(PATH_TO_DATA, 'test_preprocessed.csv'), index=False)
